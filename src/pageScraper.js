  ...
  async scraper(browser, url, type) {
    ...
    switch (type) {
      case 'steves':
        ...
        return { store: 'Steve\'s \t', title: steveTitle, isAvailable: steveStatus !== 'Out of stock' };
        break;
      ...
      case 'lm':
        ...
        return { store: 'L&M \t', title: LmTitle, isAvailable: onlineStock === 'In Stock' || !!storeStock };
        break;
      ...
      case 'archambault':
        ...
        return { store: 'Archambault \t', title: archTitle, isAvailable: !!archIsAvailable };
        break;
      ...
      case 'diplomatique':
        ...
        return { store: 'Diplomatique', title: diploTitle, isAvailable: diploIsAvailable !== 'Out of stock' };
      ...
      case 'kijiji':
        ...
        return { store: `Kijiji \t`, title: `${titles.length} results`, isAvailable: containsMascis };
      default:
        break;
    }
  }
